...
namespace Starter.Migrations
{
    ...
    [Migration("20160210165929_ResultsHelpersAddedToContext")]
    partial class ResultsHelpersAddedToContext
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Starter.Controllers.TestExceptionDetails", b =>
                {
                    b.Property<string>("strExceptionMessage");

                    b.Property<int?>("StoredStepDetailsStoredStepDetailsID");

                    b.Property<string>("strExceptionType");

                    b.HasKey("strExceptionMessage");
                });
            ...
            modelBuilder.Entity("Starter.Controllers.TestExceptionDetails", b =>
                {
                    b.HasOne("Starter.Models.StoredStepDetails")
                        .WithMany()
                        .HasForeignKey("StoredStepDetailsStoredStepDetailsID");
                });
