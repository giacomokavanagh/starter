...
{
    public partial class TestCaseVisibility : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_TestRunner_TestRunnerGroup_TestRunnerGroupID", table: "TestRunner");
            migrationBuilder.DropForeignKey(name: "FK_TestRunnerLog_TestRunner_TestRunnerID", table: "TestRunnerLog");
            migrationBuilder.DropColumn(name: "DisplayTestCase", table: "TestCase");
            migrationBuilder.DropColumn(name: "DisplayStaticSteps", table: "Procedure");
            migrationBuilder.AlterColumn<string>(
                name: "Name",
                table: "TestCase",
                nullable: true);
