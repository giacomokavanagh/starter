...
{
    public partial class PageObjects : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_TestCaseStep_TestCase_TestCaseID", table: "TestCaseStep");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ObjectLibraryID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Description = table.Column<string>(nullable: false),
                    GenericFolderID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ObjectLibrary_GenericFolder_GenericFolderID",
                        column: x => x.GenericFolderID,
                        principalTable: "GenericFolder",
                        principalColumn: "GenericFolderID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagGroupID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagGroup", x => x.TagGroupID);
                });
            migrationBuilder.CreateTable(
                name: "TreeviewNodeState",
                columns: table => new
                {
                    TreeviewNodeStateID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GenericFolderID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreeviewNodeState", x => x.TreeviewNodeStateID);
                    table.ForeignKey(
                        name: "FK_TreeviewNodeState_GenericFolder_GenericFolderID",
                        column: x => x.GenericFolderID,
                        principalTable: "GenericFolder",
                        principalColumn: "GenericFolderID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PageObjectID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageObject", x => x.PageObjectID);
                    table.ForeignKey(
                        name: "FK_PageObject_ObjectLibrary_ObjectLibraryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tag_TagGroup_TagGroupID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagLinkID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ObjectLibraryID = table.Column<int>(nullable: true),
                    PageObjectID = table.Column<int>(nullable: true),
                    TagID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagLink", x => x.TagLinkID);
                    table.ForeignKey(
                        name: "FK_TagLink_ObjectLibrary_ObjectLibraryID",
                        column: x => x.ObjectLibraryID,
                        principalTable: "ObjectLibrary",
                        principalColumn: "ObjectLibraryID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TagLink_PageObject_PageObjectID",
                        column: x => x.PageObjectID,
                        principalTable: "PageObject",
                        principalColumn: "PageObjectID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_TestCaseStep_TestCase_TestCaseID",
                table: "TestCaseStep",
                column: "TestCaseID",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_TestRunner_TestRunnerGroup_TestRunnerGroupID", table: "TestRunner");
            migrationBuilder.DropForeignKey(name: "FK_TestRunnerLog_TestRunner_TestRunnerID", table: "TestRunnerLog");
            migrationBuilder.DropTable("TagLink");
            migrationBuilder.DropTable("TreeviewNodeState");
            migrationBuilder.DropTable("PageObject");
            migrationBuilder.DropTable("Tag");
            migrationBuilder.DropTable("ObjectLibrary");
            migrationBuilder.DropTable("TagGroup");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
