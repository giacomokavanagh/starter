...
{
    public partial class ProcedureStepsWithMoreLinks : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProcessInProcedure",
                columns: table => new
                {
                    ProcessInProcedureID = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessInProcedure", x => x.ProcessInProcedureID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ProcedureStepInProcessInProcedure",
                columns: table => new
                {
                    ProcedureStepInProcessInProcedureID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProcessInProcedureID = table.Column<int>(nullable: false),
                    StoredProcedureStepID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureStepInProcessInProcedure", x => x.ProcedureStepInProcessInProcedureID);
                    table.ForeignKey(
                        name: "FK_ProcedureStepInProcessInProcedure_ProcessInProcedure_ProcessInProcedureID",
                        column: x => x.ProcessInProcedureID,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_TestRunner_TestRunnerGroup_TestRunnerGroupID", table: "TestRunner");
            migrationBuilder.DropForeignKey(name: "FK_TestRunnerLog_TestRunner_TestRunnerID", table: "TestRunnerLog");
            migrationBuilder.DropTable("ProcedureStepInProcessInProcedure");
            migrationBuilder.DropTable("ProcessInProcedure");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
