    ...
    public partial class TestCase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TestCaseStepID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestCaseStep", x => x.TestCaseStepID);
                    table.ForeignKey(
                        name: "FK_TestCaseStep_ProcedureStep_ProcedureStepID",
                        column: x => x.ProcedureStepID,
                        principalTable: "ProcedureStep",
                        principalColumn: "ProcedureStepID",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_TestRunner_TestRunnerGroup_TestRunnerGroupID", table: "TestRunner");
            migrationBuilder.DropForeignKey(name: "FK_TestRunnerLog_TestRunner_TestRunnerID", table: "TestRunnerLog");
            migrationBuilder.DropTable("TestCaseStep");
            migrationBuilder.DropTable("TestCase");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
